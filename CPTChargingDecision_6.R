...
AssetCharge <- function(r, SOC_add, dwell_place, WHYTO) {
...
CPTChargingDecision <- function(SOC, distance_next, dwell_time, power, dwell_place, total_range, WHYTO) {
  ...
  r_c <- temp_c$Range
  prob_c <- temp_c$Prob
  asset_c <- AssetCharge(r_c, SOC_add, dwell_place, WHYTO)
...
CPTChargingDecisionLookAhead <- function(SOC, distance_next, distance_last, dwell_time, power, dwell_place, total_range, WHYTO, charger_last) {
